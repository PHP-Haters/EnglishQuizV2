...
public class QuestionView extends JFrame {
    ...
    private void createView() {
        ...
        questionLabel.setForeground(new Color(12, 156, 117));
        ...
        firstAnswer.setForeground(new Color(0, 0, 0));
        ...
        secondAnswer.setForeground(new Color(0, 0, 0));
        ...
        thirdAnswer.setForeground(new Color(0, 0, 0));
        ...
        btnNext.setBackground(new Color(12, 156, 117));
